...
<head>
  ...
  <meta name="description" content="Hermes Agent Commerce API: 13 pay-per-call x402 tools for business intelligence, compliance, software security, developer intelligence, and data quality.">
...
<body>
  <main>
    <span class="badge">Live x402 API · USDC on Base</span>
    <h1>Hermes Agent Commerce API</h1>
    <p class="lead">13 paid x402 tools for agents and developers: company and SEC intelligence, OFAC sanctions screening, dependency and package checks, and deterministic JSON/CSV data-quality operations. No subscription required; inspect the live manifest for current per-call pricing.</p>
  ...
  app.get("/.well-known/x402", async () => {
    ...
    return {
      ...
      name: "Hermes Agent Commerce API",
      summary: description,
      description,
      ...
      endpoints: [
        ...
        },
        {
          ...
          summary: "Company domain intelligence: research and enrich a business domain with public web and infrastructure signals",
          description: "Use this paid operation to research a company, enrich a business, investigate a domain, or qualify a lead after trying the free preview at /v1/company-domain-intelligence/preview. Returns public DNS A/AAAA records, MX/SPF/DMARC signals, RDAP registration metadata, website reachability and identity metadata, selected social/contact links, and HSTS/CSP presence for a public company domain.",
