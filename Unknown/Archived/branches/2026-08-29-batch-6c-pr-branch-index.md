...
| #64 | `feat/revenue-opportunity-router` | `5ce3bfedf4f6b456d0c20ff9313a7981b6716b2e` | Divergent old opportunity-router implementation superseded by the canonical opportunity subsystem. Preserve intent only; close without merge. |
...
Batch 6C aligns the default `main` branch to the validated canonical repository state through a normal PR/merge, preserving history. It does not force-reset `main`, merge PR #79, alter the Render-linked production branch, deploy Render, or perform live-money actions.
