...
const SECRET = 'HERMES_COMMERCE_SPEND_PRIVATE_KEY';
...
if (!names.includes(SECRET)) throw new Error('secret write could not be verified by name');

console.log(`PRODUCTION_WALLET=${account.address}`);
console.log(`SECRET_STORED=${SECRET}`);
console.log('PRIVATE_KEY_EXPOSED=false');
console.log('NETWORK=Base mainnet (8453)');
console.log('ASSET=USDC');
console.log('POLICY_BUDGET_USDC=2.38');
