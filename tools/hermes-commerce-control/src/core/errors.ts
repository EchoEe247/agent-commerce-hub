...
export const COMMERCE_ERROR_CODES = [
  ...
  "RESPONSE_TOO_LARGE",
  "TOO_MANY_REDIRECTS",
  // Policy / Mode-A boundary
  "EXTERNAL_WRITE_DISABLED",
  "LIVE_VALUE_MOVEMENT_DISABLED",
  "SECRET_ACCESS_FORBIDDEN",
  "WALLET_REQUIRED",
  "POLICY_BLOCKED",
  "B1_ID_AUTH_POLICY_REJECTED",
  // Scoped B1 submission (one bounty, one artifact)
  "B1_SCOPED_AUTHORIZATION_REJECTED",
  "B1_ARTIFACT_HASH_MISMATCH",
  "B1_ARTIFACT_MALFORMED",
  "B1_EXECUTOR_MISMATCH",
  "B1_AUTH_TOKEN_UNAVAILABLE",
  "B1_CONSUMER_ALREADY_USED",
  // Adapter / capability
